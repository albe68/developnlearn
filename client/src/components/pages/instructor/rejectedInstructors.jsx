...
import { rejectedInstructors } from '../../../api/endpoints/auth/instructorManagement';
import { useState,useEffect } from 'react';
export default function RejectedInstructors() {
  const [instructors,setrejectedInstructors]=useState([]);
 
  const fetchData=async()=>{
   try{ const response=await rejectedInstructors();
    console.log(response)
    setrejectedInstructors(response?.data);
  ...
  return (
    ...
    <div className="flex items-center gap-x-3">
        <h2 className="text-lg font-medium text-gray-800 dark:text-white">Rejected Instructors</h2>

        <span className="px-3 py-1 text-xs text-blue-600 bg-blue-100 rounded-full dark:bg-gray-800 dark:text-blue-400">2 Instructors</span>
    </div>
                ...
                <div className="overflow-hidden border border-gray-200 dark:border-gray-700 md:rounded-lg">
                    <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        ...
                        <tbody className="bg-white divide-y divide-gray-200 dark:divide-gray-700 dark:bg-gray-900">
                            {instructors.map(({_id,firstName},index)=>{
                                return(
                                    <tr>
                                    <td className="px-4 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
                                        <div className="inline-flex items-center gap-x-3">
                                            ...
                                            <div className="flex items-center gap-x-2">
                                                ...
                                                <div>
                                                    <h2 className="font-medium text-gray-800 dark:text-white ">{firstName}</h2>
                                                    <p className="text-sm font-normal text-gray-600 dark:text-gray-400">{_id}</p>
                                                </div>
                                            </div>
                                        </div>
                                    </td>
