...
export function CouseDetailCard() {
  ...
  const fetchData = async (route) => {
    const courses = await IndividualCourseSingle(route);
  ...
  return (
    <Card  className="w-full max-w-[26rem] shadow-lg mr-4">
...
alt="ui/ux review check"
      ...
      <CardBody>
        <div className="mb-3 flex items-center justify-between">
          <Typography key={courses?.title} variant="h5" color="blue-gray" className="font-medium">
            {courses.title}
          </Typography>
          <Typography
            color="blue-gray"
