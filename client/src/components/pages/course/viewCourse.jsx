...
const content = [
    { name: '. Install and Configure the OpenAI SDK in a Node.js Project', href: '#', current: true },
    { name: 'Initialize Prisma in a TypeScript Node Project', href: '/courses', current: false },
    ...
    <>
      <section className=" dark:bg-gray-900">
        <div className="gap-16 items-center py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-16 lg:px-6">
          ...
          <div className="bg-white font-light text-gray-500 sm:text-lg dark:text-gray-400">
            <div>
<Chip className="text-xs h-5 px-1 max-w-max inline-flex items-center" color="green" value="Free" size="sm" />
            ...
            <div>
            <h4 className="text-xl font-semibold">Course Duration</h4>
            <p className="text-black">18 weeks</p>
            <p>12 lessons</p>
            <h1>Published 2 years ago</h1>
            <h1>Updated 1 year ago</h1>
            <Chip variant="ghost" className="text-xs h-5 px-1 max-w-max inline-flex items-center" color="green" value="Advanced" size="sm" />
        ...
        {content.map((contents)=>(
              ...
              <div className="border-b border-gray-200 button-container flex items-center py-2">
                ...
                <button
                  ...
                  <span className="hover:text-blue-700">1. Install and Configure the OpenAI SDK in a Node.js Project</span>


                </button>
                <div className="text-xs text-gray-700 dark:text-gray-500 ml-4">30min 4s</div>
</div>
)) }
