...
<div class="flex justify-center gap-4">
  <div class="relative grid h-[20rem] w-full max-w-[18rem] flex-col items-end justify-center overflow-hidden rounded-xl bg-white bg-clip-border text-center text-gray-700">
